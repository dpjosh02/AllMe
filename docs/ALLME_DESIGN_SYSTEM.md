...
- Component headers should rely on title, icon, and layout context. Avoid rendering eyebrow labels or descriptive subtext inside standard page/card headers unless a specific workflow needs clarification.
